...
## 2024-05-19 - Pre-allocate byte slices for JSON Marshal interfaces
...
**Action:** Use pre-allocated package-level variables instead, and include a comment warning that the returned slice is mutable to prevent callers from accidentally modifying it and corrupting global state.
