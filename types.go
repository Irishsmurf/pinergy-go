...
// zeroUnixTimeBytes is the JSON representation of a zero UnixTime.
// WARNING: This is a mutable slice. Do not modify it. It is safe to return
// from MarshalJSON because the encoding/json package copies the data.
