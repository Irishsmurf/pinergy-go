...
## 2024-05-18 - Go `MarshalJSON` interface return allocation
...
**Action:** Use pre-allocated package-level variables instead (with a warning comment about mutability) to completely eliminate allocations for static return values.
