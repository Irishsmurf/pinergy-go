...
## 2024-05-20 - Go interface method inline slice allocation
...
**Action:** Use pre-allocated package-level variables instead. Include a comment warning that the returned slice is mutable to prevent callers from accidentally modifying it and corrupting global state.
