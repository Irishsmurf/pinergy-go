...
## 2024-05-20 - Go JSON Marshal inline slice allocation
...
**Action:** Use pre-allocated package-level variables for static byte slice returns in `MarshalJSON` to eliminate heap allocations.
