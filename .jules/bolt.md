...
## 2024-05-18 - Avoid Inline Slice Allocation in MarshalJSON
**Learning:** Returning inline slice declarations like `[]byte("0")` from `MarshalJSON` allocates on every call, hurting performance.
**Action:** Use package-level variables for static byte slices instead.
