...
## 2024-05-23 - Go inline byte slice allocation in interface returns
...
**Action:** Use pre-allocated package-level variables instead and include a comment warning that the returned slice is mutable.
