...
// nullTimeBytes is pre-allocated to avoid heap allocation in MarshalJSON.
// WARNING: This slice is mutable. Do not modify it.
var nullTimeBytes = []byte(`"0"`)

// MarshalJSON implements json.Marshaler.
func (u UnixTime) MarshalJSON() ([]byte, error) {
	if u.IsZero() {
		return nullTimeBytes, nil
	}
	b := make([]byte, 0, 22)
	b = append(b, '"')
