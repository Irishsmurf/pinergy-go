...
// zeroTimeBytes is used for marshaling zero UnixTime to avoid heap allocations.
// Warning: This slice is mutable; do not modify it to prevent corrupting global state.
